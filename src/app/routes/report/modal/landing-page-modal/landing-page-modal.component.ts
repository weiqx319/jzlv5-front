...
export class LandingPageModalComponent extends DataViewTableComponent implements OnInit {
  ...
  constructor(private modalService: NzModalService,
    ...
    this.viewTableData['summary_type'] = "landing_page_account";
    this.viewTableData['sub_summary_type'] = "landing_page_account";
    this.source_summary = "landing_page_account";
    this.viewTableData['report_type'] = "landing_page_account";
  }


  ngOnInit() {
    this.getBizList();
    this.viewReportSetting.report_name = '定制报表-' + '着陆页报表';
