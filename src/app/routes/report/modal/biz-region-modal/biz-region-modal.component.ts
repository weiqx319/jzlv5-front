...
@Component({
  selector: 'app-biz-region-modal',
  templateUrl: './biz-region-modal.component.html',
  styleUrls: ['./biz-region-modal.component.scss'],
  providers: [TableItemService, RegionListService]
})
export class BizRegionModalComponent extends DataViewTableComponent implements OnInit {
  ...
  constructor(private modalService: NzModalService,
    ...
    this.viewTableData['summary_type'] = "biz_unit_account_region";
    this.viewTableData['sub_summary_type'] = "biz_unit_account_region";
    this.source_summary = "biz_unit_account_region";
    this.viewTableData['report_type'] = "biz_unit_region_report";
  }

  ngOnInit() {
    this.getBizList();
    this.viewReportSetting.report_name = '定制报表-' + '地域报表';
  ...
  refreshFields(data: any[]) {
    ...
    this.viewTableData['locked_items'].forEach(item => {
      ...
      if (result.isHas || item['key'] === 'province_region' || item['key'] === 'city_region') {
        if (result.isHas) {
