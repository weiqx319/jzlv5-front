...
export class ResponsibleReportComponent extends DataViewTableComponent implements OnInit {
  ...
  constructor(private modalService: NzModalService,
    ...
    this.viewTableData['summary_type'] = "responsible_account";
    this.viewTableData['sub_summary_type'] = "responsible_account";
    this.source_summary = "responsible_account";
    this.viewTableData['report_type'] = "responsible_account";
  }
