...
export class BizEffectModalComponent extends DataViewTableComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // --- 获取默认
    const localMarkInfo = this.getLocalBookMark('', this.viewTableData['summary_type'], this.menuService.currentChannelId, this.menuService.currentChannelId, 0);
  ...
  reloadData() {
    ...
    }, this.menuService.currentChannelId, this.menuService.currentChannelId, 0);
    this.refreshCount();
  }
