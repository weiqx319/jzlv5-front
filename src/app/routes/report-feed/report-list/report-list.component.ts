...
export class ReportListComponent implements OnInit {
  ...
  public reportTab = [
    { 'name': '报表列表', key: 'list' },
    { 'name': '报表模板', key: 'tpl' },
    // {'name': '定制报表', key: 'custom'},
    // {'name': '病种效果报告', key: 'biz_unit_report'},
    // {'name': '病种小时报告', key: 'biz_unit_hours_report'},
    // {'name': '病种地域报告', key: 'biz_unit_region_report'},
  ];
  ...
  createReport(): void {
    ...
    this.router.navigate(['/report/feed/create'], { queryParams: this.addReportSetting });

  }

  createReoprtFromTpl(tpl_id): void {
    this.router.navigate(['/report/feed/create'], { queryParams: { ...this.addReportSetting, fromTpl: tpl_id } });
  }
