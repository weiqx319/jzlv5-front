...
@Component({
  selector: 'app-materials-manage-author',
  templateUrl: './materials-manage-author.component.html',
  styleUrls: ['./materials-manage-author.component.scss']
})
export class MaterialsManageAuthorComponent implements OnInit {
  ...
  createAuthor() {
    const add_modal = this.modalService.create({
      nzTitle: '添加作者',
      nzWidth: 600,
      nzContent: AddMaterialManageAuthorComponent,
      nzClosable: false,
  ...
  deleteAuthor(data) {
    ...
    this.materialsManageService.deleteMaterialsAuthor(body, {cid: this.cid,publisher_id:this.menuService.currentPublisherId}).subscribe(result => {
