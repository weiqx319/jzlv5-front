...
@Component({
  selector: 'app-material-manage-logo',
  templateUrl: './materials-manage-logo.component.html',
  styleUrls: ['./materials-manage-logo.component.scss','../../materials-manage.component.scss']
})
export class MaterialsManageLogoComponent implements OnInit {
