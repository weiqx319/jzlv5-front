...
@Component({
  selector: 'app-materials-manage-report-image',
  templateUrl: './materials-manage-report-image.component.html',
  styleUrls: ['./materials-manage-report-image.component.scss', '../../materials-manage.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [ReportService, DataViewService, ViewItemService, TableItemFeedService, MaterialsService]
})
export class MaterialsManageReportImageComponent extends DataViewTableComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.selected_items = this.localSt.retrieve('image_report_selected_items')||[];
    ...
    if (this.localSt.retrieve('image_report_defaultData_'+this.currentUser.user_id + '_' + this.userOperdInfo.select_uid + '_' + this.userOperdInfo.select_cid)) {
      this.defaultData = this.localSt.retrieve('image_report_defaultData_'+this.currentUser.user_id + '_' + this.userOperdInfo.select_uid + '_' + this.userOperdInfo.select_cid);
    }
  ...
  refreshData(status?) {
    ...
    this.localSt.store('image_report_defaultData_'+this.currentUser.user_id + '_' + this.userOperdInfo.select_uid + '_' + this.userOperdInfo.select_cid, this.defaultData);

    this.materialsManageService.getImageReportList(postData, {
  ...
  changeField() {
    ...
    add_modal.afterClose.subscribe((result) => {
      if (result.dataType && result.dataType === 'table') {
        ...
        this.localSt.store('image_report_selected_items', result.data);
