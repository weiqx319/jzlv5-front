...
@Component({
  selector: 'app-launch-target-basic-kuaishou',
  templateUrl: './launch-target-basic-kuaishou.component.html',
  styleUrls: ['./launch-target-basic-kuaishou.component.scss']
})
export class LaunchTargetBasicKuaishouComponent implements OnInit {
  ...
  public defaultData: { audience_template_name: any, landing_type: any, inventory_type_list: any, parent_id?: any, audience_template_id?: any, audience_desc: any, audience_setting: any, delivery_range?: any, marketing_target?: any, flow_type?: any, opt_target?: any, target_setting?: any } = {
  ...
  getLaunchAudienceTemplateDetail(id) {
    ...
    this.launchRpaService
      .getLaunchAudienceTemplateDetailKs(id, {
        cid: this.cid,
      })
      .subscribe(
        (result: any) => {
  ...
  getEditData() {
    const getParentTarget = this.launchRpaService.getTargetDetailByKs(this.audienceTemplateId, { cid: this.cid });
    const getChildTarget = this.launchRpaService.getTargetDetailByKs(this.childAudienceTemplateId, { cid: this.cid });
  ...
  updateSingleChecked(data, type) {
    if (type === 'age') {
      ...
      if (this.defaultData.inventory_type_list === '') {
        if (data.every(item => !item.checked)) {
  ...
  doSave() {
    ...
    if (!this.saveing) {
      ...
      if ((this.targetType === 'basicEdit' || this.targetType === 'packageEdit')) {
        ...
        this.launchRpaService
          .updateLaunchAudienceTemplateKs(this.defaultData, id, {
            cid: this.cid,
        ...
        this.launchRpaService
          .addLaunchAudienceTemplateKs(this.defaultData, {
            cid: this.cid,
          })
          .subscribe(
            (result: any) => {
