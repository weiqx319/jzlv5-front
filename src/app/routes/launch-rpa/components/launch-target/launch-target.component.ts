...
@Component({
  selector: 'app-launch-target',
  templateUrl: './launch-target.component.html',
  styleUrls: ['./launch-target.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class LaunchTargetComponent implements OnInit {
