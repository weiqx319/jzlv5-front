...
@Component({
  selector: 'app-launch-group-list-niu',
  templateUrl: './launch-group-list-niu.component.html',
  styleUrls: ['./launch-group-list-niu.component.scss']
})
export class LaunchGroupListNiuComponent implements OnInit {
