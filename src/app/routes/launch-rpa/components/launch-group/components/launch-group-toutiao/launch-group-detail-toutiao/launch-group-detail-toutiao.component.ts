...
@Component({
  selector: 'app-launch-group-detail-toutiao',
  templateUrl: './launch-group-detail-toutiao.component.html',
  styleUrls: ['./launch-group-detail-toutiao.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class LaunchGroupDetailToutiaoComponent implements OnInit {
  ...
  public toutiaoAcTemplateVisible = false;
  ...
  openToutiaoAcTemplate() {
    this.isEdit = false;
    this.toutiaoAcTemplateVisible = true;
  }

  closeToutiaoAcTemplate() {
    this.toutiaoAcTemplateVisible = false;
  }
