...
import { AddLaunchGroupQianchuanComponent } from "../add-launch-group-qianchuan/add-launch-group-qianchuan.component";

@Component({
  selector: 'app-launch-group-detail-qianchuan',
  templateUrl: './launch-group-detail-qianchuan.component.html',
  styleUrls: ['./launch-group-detail-qianchuan.component.scss']
})
export class LaunchGroupDetailQianchuanComponent implements OnInit {
  ...
  editLaunchGroup(data) {
    const add_modal = this.modalService.create({
      nzTitle: '编辑投放项目',
      nzWidth: 900,
      nzContent: AddLaunchGroupQianchuanComponent,
      nzClosable: false,
