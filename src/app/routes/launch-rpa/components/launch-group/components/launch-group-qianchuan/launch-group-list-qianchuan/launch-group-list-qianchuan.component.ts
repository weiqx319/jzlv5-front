...
@Component({
  selector: 'app-launch-group-list-qianchuan',
  templateUrl: './launch-group-list-qianchuan.component.html',
  styleUrls: ['./launch-group-list-qianchuan.component.scss']
})
export class LaunchGroupListQianchuanComponent implements OnInit {
