...
@Component({
  selector: 'app-add-launch-group-qianchuan',
  templateUrl: './add-launch-group-qianchuan.component.html',
  styleUrls: ['./add-launch-group-qianchuan.component.scss']
})
export class AddLaunchGroupQianchuanComponent implements OnInit {
