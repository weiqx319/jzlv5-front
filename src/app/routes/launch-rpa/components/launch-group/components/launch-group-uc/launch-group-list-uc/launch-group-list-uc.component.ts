...
@Component({
  selector: 'app-launch-group-list-uc',
  templateUrl: './launch-group-list-uc.component.html',
  styleUrls: ['./launch-group-list-uc.component.scss']
})
export class LaunchGroupListUcComponent implements OnInit {
