...
@Component({
  selector: 'app-launch-group-template-uc',
  templateUrl: './launch-group-template-uc.component.html',
  styleUrls: ['./launch-group-template-uc.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class LaunchGroupTemplateUcComponent implements OnInit {
  ...
  public checkErrorTip = {
    ...
    material_title_lst: {
      is_show: false,
      tip_text: '按素材或创意组选择标题，素材或创意组下标题不能为空'
    },
  };
  ...
  checkBasicData() {
    ...
    // 转化出价
    if (template_struct.adgroup.opt_target === 3 && !template_struct.adgroup.opt_bid) {
    ...
    if (template_struct.adgroup.deep_convert_type === 3 && !template_struct.adgroup.roi_target) {
