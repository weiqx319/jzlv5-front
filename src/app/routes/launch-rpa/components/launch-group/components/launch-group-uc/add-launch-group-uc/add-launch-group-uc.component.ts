...
@Component({
  selector: 'app-add-launch-group-uc',
  templateUrl: './add-launch-group-uc.component.html',
  styleUrls: ['./add-launch-group-uc.component.scss']
})
export class AddLaunchGroupUcComponent implements OnInit {
