...
import { AddLaunchGroupGdtComponent } from "../add-launch-group-gdt/add-launch-group-gdt.component";
...
@Component({
  selector: 'app-launch-group-detail-gdt',
  templateUrl: './launch-group-detail-gdt.component.html',
  styleUrls: ['./launch-group-detail-gdt.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class LaunchGroupDetailGdtComponent implements OnInit {
  ...
  editLaunchGroup(data) {
    const add_modal = this.modalService.create({
      nzTitle: '编辑投放项目',
      nzWidth: 900,
      nzContent: AddLaunchGroupGdtComponent,
      nzClosable: false,
