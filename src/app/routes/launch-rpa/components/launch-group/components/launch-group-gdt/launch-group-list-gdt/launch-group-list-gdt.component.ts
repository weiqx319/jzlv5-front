...
@Component({
  selector: 'app-launch-group-list-gdt',
  templateUrl: './launch-group-list-gdt.component.html',
  styleUrls: ['./launch-group-list-gdt.component.scss']
})
export class LaunchGroupListGdtComponent implements OnInit {
