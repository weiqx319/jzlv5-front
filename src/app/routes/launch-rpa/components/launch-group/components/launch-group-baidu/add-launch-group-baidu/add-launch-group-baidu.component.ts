...
@Component({
  selector: 'app-add-launch-group-baidu',
  templateUrl: './add-launch-group-baidu.component.html',
  styleUrls: ['./add-launch-group-baidu.component.scss']
})
export class AddLaunchGroupBaiduComponent implements OnInit {
