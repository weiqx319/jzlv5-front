...
@Component({
  selector: 'app-launch-group-detail-baidu',
  templateUrl: './launch-group-detail-baidu.component.html',
  styleUrls: ['./launch-group-detail-baidu.component.scss']
})
export class LaunchGroupDetailBaiduComponent implements OnInit {
