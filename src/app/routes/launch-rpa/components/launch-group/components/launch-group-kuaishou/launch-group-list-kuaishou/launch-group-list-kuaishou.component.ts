...
@Component({
  selector: 'app-launch-group-list-kuaishou',
  templateUrl: './launch-group-list-kuaishou.component.html',
  styleUrls: ['./launch-group-list-kuaishou.component.scss']
})
export class LaunchGroupListKuaishouComponent implements OnInit {
