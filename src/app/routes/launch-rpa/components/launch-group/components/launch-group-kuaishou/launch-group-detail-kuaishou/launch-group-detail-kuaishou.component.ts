...
import { AddLaunchGroupKuaishouComponent } from "../add-launch-group-kuaishou/add-launch-group-kuaishou.component";

@Component({
  selector: 'app-launch-group-detail-kuaishou',
  templateUrl: './launch-group-detail-kuaishou.component.html',
  styleUrls: ['./launch-group-detail-kuaishou.component.scss']
})
export class LaunchGroupDetailKuaishouComponent implements OnInit {
  ...
  editLaunchGroup(data) {
    const add_modal = this.modalService.create({
      nzTitle: '编辑投放项目',
      nzWidth: 900,
      nzContent: AddLaunchGroupKuaishouComponent,
      nzClosable: false,
      nzMaskClosable: false,
      nzWrapClassName: 'add-launch-group-kuaishou',
      nzFooter: null,
      nzComponentParams: {
        isEdit: true,
