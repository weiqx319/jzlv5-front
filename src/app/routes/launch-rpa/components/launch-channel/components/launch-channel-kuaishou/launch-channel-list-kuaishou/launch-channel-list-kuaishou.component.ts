...
import {AddChannelKuaishouComponent} from "../add-channel-kuaishou/add-channel-kuaishou.component";
import {AddChannelGdtComponent} from "../../launch-channel-gdt/add-channel-gdt/add-channel-gdt.component";

@Component({
  selector: 'app-launch-channel-list-kuaishou',
  templateUrl: './launch-channel-list-kuaishou.component.html',
  styleUrls: ['./launch-channel-list-kuaishou.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class LaunchChannelListKuaishouComponent implements OnInit {
  ...
  refreshData(status?) {
    ...
    this.launchRpaService.getChannelListByKs(body, {
      result_model: 'page',
  ...
  deleteLaunchChannel(data) {
    ...
    this.launchRpaService.deleteLaunchChannelListByKs(body, {cid: this.authService.getCurrentUserOperdInfo().select_cid}).subscribe(result => {
  ...
  createChannel() {
    const add_modal = this.modalService.create({
      nzTitle: '创建渠道',
      nzWidth: 900,
      nzContent: AddChannelKuaishouComponent,
      nzClosable: false,
      nzMaskClosable: false,
      nzWrapClassName: 'add-channel-kuaishou',
      nzFooter: null,
      nzComponentParams: {
