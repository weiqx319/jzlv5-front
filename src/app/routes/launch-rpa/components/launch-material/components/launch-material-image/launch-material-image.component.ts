...
@Component({
  selector: 'app-launch-material-image',
  templateUrl: './launch-material-image.component.html',
  styleUrls: ['./launch-material-image.component.scss']
})
export class LaunchMaterialImageComponent implements OnInit {
  ...
  handSync() {
    ...
    this.launchRpaService.syncMaterialJob(this.menuService.currentPublisherId, 'image', this.syncChanPubIds,this.syncMaterialTags).subscribe(result => {
      this.syncChanPubIds = [];
  ...
  refreshData(status?) {
    ...
    this.launchRpaService.getLaunchImageList(this.menuService.currentPublisherId, postData, {
  ...
  delMaterialsSingle(data) {
    ...
    this.launchRpaService.deleteImageMaterials(data.material_id, {}).subscribe(result => {
  ...
  batchDeleteMaterial() {
    ...
    this.launchRpaService.deleteImageMaterialsBatch(body).subscribe(result => {
