...
@Component({
  selector: 'app-launch-material-cover',
  templateUrl: './launch-material-cover.component.html',
  styleUrls: ['./launch-material-cover.component.scss']
})
export class LaunchMaterialCoverComponent implements OnInit {
  ...
  refreshData(status?) {
    ...
    this.launchRpaService.getLaunchCoverImageList(null, this.menuService.currentPublisherId, postData, {
  ...
  delMaterialsSingle(data) {
    ...
    this.launchRpaService.deleteCoverImageMaterials(data.material_id, {}).subscribe(result => {
  ...
  batchDeleteMaterial() {
    ...
    this.launchRpaService.deleteCoverImageMaterialsBatch(body).subscribe(result => {
