...
@Component({
  selector: 'app-launch-group-list-qc',
  templateUrl: './launch-group-list-qc.component.html',
  styleUrls: ['./launch-group-list-qc.component.scss']
})
export class LaunchGroupListQcComponent implements OnInit {
