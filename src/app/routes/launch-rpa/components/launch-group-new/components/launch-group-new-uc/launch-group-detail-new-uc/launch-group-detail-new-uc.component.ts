...
@Component({
  selector: 'app-launch-group-detail-new-uc',
  templateUrl: './launch-group-detail-new-uc.component.html',
  styleUrls: ['./launch-group-detail-new-uc.component.scss']
})
export class LaunchGroupDetailNewUcComponent implements OnInit {
