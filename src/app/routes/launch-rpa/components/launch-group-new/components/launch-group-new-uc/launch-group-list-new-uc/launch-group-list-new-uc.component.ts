...
import {AddLaunchGroupNewUcComponent} from "../add-launch-group-new-uc/add-launch-group-new-uc.component";

@Component({
  selector: 'app-launch-group-list-new-uc',
  templateUrl: './launch-group-list-new-uc.component.html',
  styleUrls: ['./launch-group-list-new-uc.component.scss']
})
export class LaunchGroupListNewUcComponent implements OnInit {
  ...
  refreshData(status?) {
    ...
    this.launchRpaService.getLaunchProjectReportListNew(this.menuService.currentPublisherId,postData, {
  ...
  createLaunchGroup() {
    const add_modal = this.modalService.create({
      nzTitle: '创建投放项目',
      nzWidth: 900,
      nzContent: AddLaunchGroupNewUcComponent,
      nzClosable: false,
