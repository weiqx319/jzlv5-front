...
@Component({
  selector: 'app-add-launch-group-bd',
  templateUrl: './add-launch-group-bd.component.html',
  styleUrls: ['./add-launch-group-bd.component.scss']
})
export class AddLaunchGroupBdComponent implements OnInit {
