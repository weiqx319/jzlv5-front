...
@Component({
  selector: 'app-add-landing-page-bd',
  templateUrl: './add-landing-page-bd.component.html',
  styleUrls: ['./add-landing-page-bd.component.scss'],
  providers:[AssetManagementService]
})
export class AddLandingPageBdComponent implements OnInit {
  ...
  ngOnInit() {
    if (this.chanPubId) {
      this.defaultData.chan_pub_id=this.chanPubId;
      this.defaultData.subject=this.subject+'';
    }
