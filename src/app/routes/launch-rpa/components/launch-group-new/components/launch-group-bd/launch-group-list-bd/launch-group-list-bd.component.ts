...
@Component({
  selector: 'app-launch-group-list-bd',
  templateUrl: './launch-group-list-bd.component.html',
  styleUrls: ['./launch-group-list-bd.component.scss']
})
export class LaunchGroupListBdComponent implements OnInit {
