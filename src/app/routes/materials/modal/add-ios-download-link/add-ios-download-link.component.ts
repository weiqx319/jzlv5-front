...
@Component({
  selector: 'app-add-ios-download-link',
  templateUrl: './add-ios-download-link.component.html',
  styleUrls: ['./add-ios-download-link.component.scss']
})
export class AddIosDownloadLinkComponent implements OnInit {
  ...
  public list = [
    {
      app_url_type: '2', // 1 安卓  2 苹果   3 落地页
      app_url_name: '', // 链接名称
      app_url: '', // 链接
