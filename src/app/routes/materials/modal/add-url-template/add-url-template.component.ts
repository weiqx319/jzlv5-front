...
@Component({
  selector: 'app-add-url-template',
  templateUrl: './add-url-template.component.html',
  styleUrls: ['./add-url-template.component.scss']
})
export class AddUrlTemplateComponent implements OnInit {



  @Input() urlType = 'deeplink_url';
  @Input() urlTypeMap:any = {};
  @Input() urlTypeNameMap:any = {};
  ...
  public list = [
    {
      app_url_type: '4', // 1 安卓  2 苹果   3 落地页
      app_url_name: '', // 链接名称
      app_url: '', // 链接
  ...
  doSave() {
    this.list.forEach(item=> {
      item['app_url_type'] = this.urlTypeMap[this.urlType];
    });
