...
@Component({
  selector: 'app-add-external-url',
  templateUrl: './add-external-url.component.html',
  styleUrls: ['./add-external-url.component.scss']
})
export class AddExternalUrlComponent implements OnInit {
  ...
  public list = [
    {
      app_url_type: '3', // 1 安卓  2 苹果   3 落地页
      app_url_name: '', // 链接名称
      app_url: '', // 链接
