...
@Component({
  selector: 'app-materials-author',
  templateUrl: './materials-author.component.html',
  styleUrls: ['./materials-author.component.scss']
})
export class MaterialsAuthorComponent implements OnInit {
  ...
  deleteAuthor(data) {
    this.loading = true;
    this.materialsService.deleteMaterialsAuthor(data.material_author_id, {cid: this.cid,publisher_id:this.menuService.currentPublisherId}).subscribe(result => {
