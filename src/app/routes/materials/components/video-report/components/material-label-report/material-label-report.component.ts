...
@Component({
  selector: 'app-material-label-report',
  templateUrl: './material-label-report.component.html',
  styleUrls: ['./material-label-report.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [TableItemFeedService, DataViewEditWrapService, MaterialsService],
})
export class MaterialLabelReportComponent extends DataViewTableComponent implements OnInit {
  ...
  constructor(
    ...
    this.viewTableData['summary_type'] = "materials_video_label";
    this.viewTableData['sub_summary_type'] = "materials_video_label";
    this.source_summary = "materials_video_label";
  }
  ...
  reloadData(reloadChart = true) {
    ...
    }, this.menuService.currentPublisherId, this.menuService.currentPublisherId);
    this.refreshCount();
