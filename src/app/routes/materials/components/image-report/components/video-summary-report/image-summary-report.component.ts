...
@Component({
  selector: 'app-image-summary-report',
  templateUrl: './image-summary-report.component.html',
  styleUrls: ['./image-summary-report.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [TableItemFeedService, DataViewEditWrapService, MaterialsService],
})
export class ImageSummaryReportComponent extends DataViewTableComponent implements OnInit {
  ...
  constructor(
    ...
    this.viewTableData['summary_type'] = "materials_image";
    this.viewTableData['sub_summary_type'] = "materials_image";
    this.source_summary = "materials_image";
  }
  ...
  getRowHeight(row) {
    ...
    if (row['material_id'] || row['preview_url']) {
      return 200;
    } else {
      return 50;
    }
