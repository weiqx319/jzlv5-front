...
@Component({
  selector: 'app-ios-download-link',
  templateUrl: './ios-download-link.component.html',
  styleUrls: ['./ios-download-link.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class IosDownloadLinkComponent implements OnInit {
  ...
  addLink() {
    const add_modal = this.modalService.create({
      nzTitle: '添加IOS下载链接',
      nzWidth: 900,
      nzContent: AddIosDownloadLinkComponent,
      nzClosable: false,
      nzMaskClosable: false,
      nzWrapClassName: 'add-ios-download-link',
      nzFooter: null,
      nzComponentParams: {
        isEdit: false
      },
