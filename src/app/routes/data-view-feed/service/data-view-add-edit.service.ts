...
export class DataViewAddEditService {
  ...
  showAdgroup(body,publisherId=0): any {
    let url = '/data_view/adgroup/show';
    if(publisherId == 6) {
       url = '/data_view/feed/tencent/adgroup/show';
    }
  ...
  showAdgroupTargetUc(body): any {
    const url = '/data_view/feed/uc/show_adgroup_audience';
    return this._httpClient.post(url, body);
  }
  showUcTargetById(body): any {
    const url = '/data_view/feed/uc/show_audience';
    return this._httpClient.post(url, body);
  }
