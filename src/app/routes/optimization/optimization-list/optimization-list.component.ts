///<reference path="../service/optimization-item.service.ts"/>
...
import { splitDate, formatDate, generateTimeTip, generateTimeResult } from '@jzl/jzl-util';
...
@Component({
  ...
  styleUrls: ['./optimization-list.component.scss'],
  providers: [OptimizationItemService],
