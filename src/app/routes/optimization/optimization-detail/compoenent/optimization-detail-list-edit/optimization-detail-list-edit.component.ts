...
import { EditKeywordSingleModalComponent } from "../../../../../module/data-view-operation/edit-keyword-single/edit-keyword-single-modal.component";

@Component({
  selector: 'app-optimization-detail-list-edit',
  templateUrl: './optimization-detail-list-edit.component.html',
  styleUrls: ['./optimization-detail-list-edit.component.scss'],
  providers: [RegionListService]
})

export class OptimizationDetailListEditComponent implements OnInit {
  ...
  public menuList = {
    "single": [
      { key: 'editing_optimization', 'name': '优化设置', 'is_show': true },
