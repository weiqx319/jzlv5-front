...
@Component({
  selector: 'app-data-analytics-table',
  templateUrl: './data-analytics-table.component.html',
  styleUrls: ['../../../../../styles/routes/routes.scss', './data-analytics-table.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [ViewItemServiceSem, ViewItemServiceFeed],
})
export class DataAnalyticsTableComponent extends DataViewTableComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.route.data.subscribe((data) => {
      ...
      if (data['group_type'] === 'target_report') {
  ...
  ngOnInit() {
    ...
    this.viewTableData['selected_items'] = this.viewItemService.getDefaultItemsBySummaryType(this.source_summary, true, this.viewTableData['report_type'],);
    ...
    // --- 获取默认
    const localMarkInfo = this.getLocalBookMark('analytics', this.source_summary, this.menuService.currentChannelId, this.menuService.currentPublisherId);
