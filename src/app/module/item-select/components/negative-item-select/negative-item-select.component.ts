...
@Component({
  selector: 'app-negative-item-select',
  templateUrl: './negative-item-select.component.html',
  styleUrls: ['./negative-item-select.component.scss']
})
export class NegativeItemSelectComponent implements OnInit {
  ...
  @Output() doCancel: EventEmitter<Object> = new EventEmitter<Object>();
...
/*  @Input() set typeConfig(data: any) {
  ...
  isPublisherShow(p_index) {
    const accounts = this.all_items[this.item_type][p_index];
  ...
  isAccountShow(p_index, a_index) {
    const campaigns = this.all_items[this.item_type][p_index].detail[a_index];
    let publisher_show = false;
  ...
  isCampaignShow(p_index, a_index, c_index) {
    const groups = this.all_items[this.item_type][p_index].detail[a_index].detail[c_index];
    let publisher_show = false;
  ...
  toCombineCampaignStruct(p_index, a_index, c_index) {
    const c_item = this.all_items[this.item_type][p_index].detail[a_index].detail[c_index];
  ...
  toCombineAccountStruct(p_index, a_index) {
    const a_item = this.all_items[this.item_type][p_index].detail[a_index];
  ...
  toCombinePublisherStruct(p_index) {
    const p_item = this.all_items[this.item_type][p_index];
  ...
  itemsChange() {
    this.selected_detail = {};
    this.all_items[this.item_type].forEach((p_item, p_index) => {
